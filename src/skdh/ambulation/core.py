...
class Ambulation(BaseProcess):
    ...
    def predict(self, time, accel, **kwargs):
        ...
        # load model
        model = self._load_model("model/model.txt")
