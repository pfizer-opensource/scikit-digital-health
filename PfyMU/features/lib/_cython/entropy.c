...
>>>>>>> 61922aa20bbc6cc245e6524f0d934276c310ae03
...
=======
        "name": "PfyMU.features.lib._cython.entropy",
        "sources": [
            "/Users/adamol/Documents/Python Packages/PfyMU/PfyMU/features/lib/_cython/entropy.pyx"
>>>>>>> c58b4fb23624c66aa098d7bd6127a9e5dd012ffe
        ]
    },
...
static const char __pyx_k_SignalEntropy[] = "SignalEntropy";
...
>>>>>>> c58b4fb23624c66aa098d7bd6127a9e5dd012ffe
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("SignalEntropy (wrapper)", 0);
...
>>>>>>> c58b4fb23624c66aa098d7bd6127a9e5dd012ffe
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("SampleEntropy (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_M)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("SampleEntropy", 1, 3, 3, 1); __PYX_ERR(0, 96, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_r)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("SampleEntropy", 1, 3, 3, 2); __PYX_ERR(0, 96, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "SampleEntropy") < 0)) __PYX_ERR(0, 96, __pyx_L3_error)
      }
 ...
 */
        ...
        __pyx_t_25 = (((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_B.data + __pyx_t_41 * __pyx_v_B.strides[0]) ) + __pyx_t_42 * __pyx_v_B.strides[1]) ) + __pyx_t_43 * __pyx_v_B.strides[2]) ))) == 0.0) != 0);
        if (!__pyx_t_25) {
        } else {
          __pyx_t_24 = __pyx_t_25;
        ...
        __pyx_t_25 = (((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_A.data + __pyx_t_43 * __pyx_v_A.strides[0]) ) + __pyx_t_42 * __pyx_v_A.strides[1]) ) + __pyx_t_41 * __pyx_v_A.strides[2]) ))) == 0.0) != 0);
        __pyx_t_24 = __pyx_t_25;
 ...
 */
        /*else*/ {
          __pyx_t_44 = __pyx_v_wind;
          __pyx_t_45 = __pyx_v_mm;
          __pyx_t_46 = __pyx_v_axis;
          __pyx_t_38 = (*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_A.data + __pyx_t_44 * __pyx_v_A.strides[0]) ) + __pyx_t_45 * __pyx_v_A.strides[1]) ) + __pyx_t_46 * __pyx_v_A.strides[2]) )));
          __pyx_t_46 = __pyx_v_wind;
          __pyx_t_45 = (__pyx_v_mm - 1);
          __pyx_t_44 = __pyx_v_axis;
          __pyx_t_47 = (*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_B.data + __pyx_t_46 * __pyx_v_B.strides[0]) ) + __pyx_t_45 * __pyx_v_B.strides[1]) ) + __pyx_t_44 * __pyx_v_B.strides[2]) )));
          ...
          __pyx_t_45 = __pyx_v_mm;
          __pyx_t_46 = __pyx_v_axis;
          *((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ent.data + __pyx_t_44 * __pyx_v_ent.strides[0]) ) + __pyx_t_45 * __pyx_v_ent.strides[1]) )) + __pyx_t_46)) )) = (-log((__pyx_t_38 / __pyx_t_47)));
        }
        __pyx_L25:;
=======
 *                 ent[wind, mm, axis] = -log(A[wind, mm, axis] / B[wind, mm - 1, axis])             # <<<<<<<<<<<<<<
 ...
 *                     ent[wind, mm, axis] = -log(A[wind, mm, axis] / B[wind, mm - 1, axis])
=======
  /* "PfyMU/features/lib/_cython/entropy.pyx":137
 *                 ent[wind, mm, axis] = -log(A[wind, mm, axis] / B[wind, mm - 1, axis])
>>>>>>> c58b4fb23624c66aa098d7bd6127a9e5dd012ffe
 * 
 *     return entropy             # <<<<<<<<<<<<<<
