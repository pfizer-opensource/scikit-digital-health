...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "/Users/adamol/Documents/Python Packages/PfyMU/PfyMU/features/lib/_cython/ratioBeyondRSigma.pyx"
        ]
    },
...
static const char __pyx_k_RatioBeyondRSigma[] = "RatioBeyondRSigma";
...
static PyObject *__pyx_pw_5PfyMU_8features_3lib_7_cython_17ratioBeyondRSigma_1RatioBeyondRSigma(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("RatioBeyondRSigma (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_r)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("RatioBeyondRSigma", 1, 2, 2, 1); __PYX_ERR(0, 10, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "RatioBeyondRSigma") < 0)) __PYX_ERR(0, 10, __pyx_L3_error)
      }
...
static int __pyx_pymod_exec_ratioBeyondRSigma(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_ratioBeyondRSigma},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initratioBeyondRSigma(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initratioBeyondRSigma(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_ratioBeyondRSigma(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_ratioBeyondRSigma(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_ratioBeyondRSigma(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'ratioBeyondRSigma' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_ratioBeyondRSigma(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("ratioBeyondRSigma", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
